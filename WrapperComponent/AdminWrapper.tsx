...
export class AdminWrapper extends React.Component<ConnectedState, IAdminWrapperState> {
    constructor(props) {
        super(props);
        this.state = {
            notifications: []
    ...
    public componentWillMount() {
        ...
        } else if (this.props.userRoles.roles.indexOf("Admin") !== 0) {
...
export const WrappedAdminWrapper = connect(mapStateToProps)(AdminWrapper);